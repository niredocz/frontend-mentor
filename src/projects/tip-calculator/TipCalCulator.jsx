...
const TipCalCulator = () => {
  ...
  const countTipAmount = (e) => {
    let a = (parseFloat(billValue) * 1) / parseFloat(peopleValue);
    let radioButtons = document.getElementsByName("bills");
    ...
    let selectedValue = selectedRadioButton;

    if (customBillValue > 0) {
      a =
        (parseFloat(billValue) * (customBillValue / 100)) /
        parseFloat(peopleValue);
    } else if (isRadioChecked != null) {
      switch (selectedValue) {
        case "5":
          a = (parseFloat(billValue) * (5 / 100)) / parseFloat(peopleValue);
          break;
        case "10":
          a = (parseFloat(billValue) * (10 / 100)) / parseFloat(peopleValue);
          break;
        case "15":
          a = (parseFloat(billValue) * (15 / 100)) / parseFloat(peopleValue);
          break;
        case "25":
          a = (parseFloat(billValue) * (25 / 100)) / parseFloat(peopleValue);
          break;
        case "50":
          a = (parseFloat(billValue) * (50 / 100)) / parseFloat(peopleValue);
          break;
        default:
          a = (parseFloat(billValue) * 1) / parseFloat(peopleValue);
      }
    }
                    ...
                    <ul className="grid grid-cols-3 gap-3">
                      <li>
                        <input
                          ...
                          checked={isRadioChecked === "tip-5"}
                          onClick={() => handleRadioChange("tip-5")}
                          required
                        />
                        <label
                          htmlFor="tip-5"
                          className="block cursor-pointer w-full py-3 px-2 rounded-md font-semibold text-2xl text-white bg-[#00474b] hover:bg-[#9fe8df] hover:text-green-900 peer-checked:bg-[#9fe8df] peer-checked:text-green-900">
                          5%
                        </label>
                      </li>
                      <li>
                        <input
                          ...
                          value="10"
                          className="hidden peer"
                          checked={isRadioChecked === "tip-10"}
                          onClick={() => handleRadioChange("tip-10")}
                          required
                        />
                        <label
                          htmlFor="tip-10"
                      ...
                      <li>
                        <input
                          ...
                          value="15"
                          className="hidden peer"
                          checked={isRadioChecked === "tip-15"}
                          onClick={() => handleRadioChange("tip-15")}
                          required
                        />
                        <label
                          htmlFor="tip-15"
                      ...
                      <li>
                        <input
                          ...
                          value="25"
                          className="hidden peer"
                          checked={isRadioChecked === "tip-25"}
                          onClick={() => handleRadioChange("tip-25")}
                          required
                        />
                        <label
                          htmlFor="tip-25"
                      ...
                      <li>
                        <input
                          ...
                          value="50"
                          className="hidden peer"
                          checked={isRadioChecked === "tip-50"}
                          onClick={() => handleRadioChange("tip-50")}
                          required
                        />
                        <label
                          htmlFor="tip-50"
